    ...
    <div class="container-fluid p-0 ">
        <div class="row justify-content-between mb-3">
            <div class="col-md-6 text-start">
                <h3 class="">Manage Staff / Sub Admin</h3>
            </div>
                        ...
                        <tbody class="table-group-divider">
                            @foreach ($staffData as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ Route('admin.view-staff', 'id=' . base64_encode($item->id)) }}"
                                            class="text-primary text-center"><i data-feather="eye"></i></a>
                                        ||
                                        {{-- <a
                                            href="{{ Route('admin.staff-permission', 'id=' . base64_encode($item->id)) }}"
                                            class="text-primary text-center" title="give permission"><i
                                                data-feather="check-circle"></i></a>
                                        || --}}
                                        <a href="{{ Route('admin.delete', 'id=' . base64_encode($item->id) . '&modelName=' . base64_encode('Admin')) }}"
                                            class="text-danger text-center"onclick="return confirm('{{ 'Are You Sure To Delete Staff : ' . $item->name }}')"><i
