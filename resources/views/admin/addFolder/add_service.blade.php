                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="serviceForm" autocomplete="off">
                                    @csrf
                                    <div class="row">
                                        <input type="hidden" name="provider_id" value="{{ Session::get('admin_id') }}">
                                        ...
                                        <div class="imgMoreBox">
                                            ...
                                            @if ($serviceImg->count())
                                                @foreach ($serviceImg as $item)
                                                    ...
                                                    <img src="{{ asset('public/upload/service/' . $item->img) }}"
                                                        class="img-fluid w-25 h-25 float-start ms-2 mb-2 position-relative"
                                                        alt=""> <span class="position-absolute">X</span></img>
                                                @endforeach
                                            @endif
                                        </div>
                                    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if ($.trim(data) == "save") {
                            ...
                            setTimeout(() => {
                                window.location = "{{ Route('admin.manage-service') }}";
                            }, 3000);
                        }
                        if ($.trim(data) == "update") {
                            $("#errMsg").hide();
